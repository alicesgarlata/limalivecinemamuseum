...
const locations = [
  ...
  },
  {
    ...
    "descriptions": {
      "young": "Pizza Street is a well-known pedestrian street in Miraflores. Officially called San Ramón Boulevard, it is a lively place with restaurants, cafés, bars, and entertainment venues where local people and visitors meet.",
      ...
      "professional": "Officially designated San Ramón Boulevard, Pizza Street is a prominent pedestrian and entertainment corridor in Miraflores. Its concentration of restaurants, cafés, bars, and tourist activity makes it a useful audiovisual setting for examining Lima’s contemporary nightlife and commercial culture."
    },
    ...
    "texts": {
      "young": {
        "brief": "Pizza Street is a famous pedestrian street in Miraflores, officially called San Ramón Boulevard.",
        "mid": "Pizza Street is a well-known pedestrian street in Miraflores. Officially called San Ramón Boulevard, it is a lively place with restaurants, cafés, bars, and entertainment venues where local people and visitors meet.",
        "long": "Pizza Street is a popular pedestrian area in Miraflores, only a few metres from Kennedy Park and Larco Avenue. Its official name is San Ramón Boulevard, and it extends for about two blocks. The street was once especially famous for its pizzerias, but today it also has Peruvian and international restaurants, cafés, cocktail bars, hotels, and other businesses. This mix of food, tourism, and nightlife makes it a lively meeting place and an interesting setting for showing contemporary Lima on screen."
      },
      "adult": {
      ...
      "professional": {
        "brief": "Officially designated San Ramón Boulevard, Pizza Street is a prominent pedestrian and entertainment corridor in Miraflores.",
        "mid": "Officially designated San Ramón Boulevard, Pizza Street is a prominent pedestrian and entertainment corridor in Miraflores. Its concentration of restaurants, cafés, bars, and tourist activity makes it a useful audiovisual setting for examining Lima’s contemporary nightlife and commercial culture.",
        "long": "Officially designated San Ramón Boulevard, Pizza Street is a pedestrian corridor of approximately two blocks located near Kennedy Park and Larco Avenue in Miraflores. Although historically identified with its pizzerias, its current commercial landscape includes Peruvian and international restaurants, cafés, cocktail bars, hotels, and entertainment venues. The boulevard’s evolving identity and intensive evening use make it a significant site for analysing tourism, consumption, sociability, and the cinematic representation of contemporary urban nightlife in Lima."
      }
    }
  },
  {
    ...
    "descriptions": {
      "young": "Larco Avenue is one of the main streets in Miraflores. It links Kennedy Park with the coast and Larcomar and is always busy with shops, restaurants, hotels, entertainment, visitors, and local residents.",
      ...
      "professional": "Larco Avenue constitutes a major commercial and tourist axis in Miraflores, connecting Kennedy Park and the district centre with the coastal zone and Larcomar. Its mixed concentration of mobility, hospitality, retail, gastronomy, and public activity makes it a representative contemporary urban corridor."
    },
    ...
    "texts": {
      "young": {
        "brief": "Larco Avenue is one of the main commercial and tourist streets in Miraflores.",
        "mid": "Larco Avenue is one of the main streets in Miraflores. It links Kennedy Park with the coast and Larcomar and is always busy with shops, restaurants, hotels, entertainment, visitors, and local residents.",
        "long": "Larco Avenue is a major street in Miraflores that runs for about thirteen blocks. It starts near Kennedy Park and the Miraflores roundabout and continues towards Armendáriz Avenue, the coastal promenade, and Larcomar. Along the route there are hotels, restaurants, cafés, bookshops, banks, shops, galleries, casinos, and offices. This constant mix of travel, shopping, tourism, and everyday public life makes the avenue an active part of contemporary Lima."
      },
      "adult": {
      ...
      "professional": {
        "brief": "Larco Avenue constitutes a major commercial, mobility, and tourist axis within Miraflores.",
        "mid": "Larco Avenue constitutes a major commercial and tourist axis in Miraflores, connecting Kennedy Park and the district centre with the coastal zone and Larcomar. Its mixed concentration of mobility, hospitality, retail, gastronomy, and public activity makes it a representative contemporary urban corridor.",
        "long": "Officially named José A. Larco Avenue, this approximately thirteen-block corridor extends from the Miraflores roundabout and Kennedy Park towards Armendáriz Avenue, the Malecón de la Reserva, and Larcomar. Hotels, restaurants, cafés, bookshops, banks, galleries, casinos, offices, and retail premises produce a dense mixture of commercial and civic functions. The avenue can therefore be interpreted not merely as transport infrastructure but as an urban axis through which mobility, tourism, consumption, entertainment, and public life converge."
      }
    }
  },
  {
    ...
    "descriptions": {
      "young": "The Country Club Lima Hotel is a historic luxury hotel in San Isidro, opposite Lima Golf Club. Its elegant façade, large halls, gardens, terraces, and artworks make it a distinctive place for films and other audiovisual productions.",
      ...
      "professional": "The Country Club Lima Hotel is a significant example of twentieth-century hospitality architecture and elite social space in San Isidro. Its Californian colonial design, preserved interiors, gardens, terraces, and art collection give the property substantial architectural, historical, and audiovisual value."
    },
    ...
    "texts": {
      "young": {
        "brief": "The Country Club Lima Hotel is a famous historic luxury hotel in San Isidro.",
        "mid": "The Country Club Lima Hotel is a historic luxury hotel in San Isidro, opposite Lima Golf Club. Its elegant façade, large halls, gardens, terraces, and artworks make it a distinctive place for films and other audiovisual productions.",
        "long": "The Country Club Lima Hotel stands on Avenida Los Eucaliptos in San Isidro, opposite Lima Golf Club. It opened on 8 February 1927 during the government of President Augusto B. Leguía and was designed by the American architect T. J. O’Brien in a Californian colonial style. Today it is a five-star hotel with guest rooms, restaurants, bars, event spaces, gardens, and colonial artworks. Its elegant and carefully preserved spaces make it especially recognisable on screen."
      },
      "adult": {
      ...
      "professional": {
        "brief": "The Country Club Lima Hotel is a significant example of twentieth-century hospitality architecture and elite social space in San Isidro.",
        "mid": "The Country Club Lima Hotel is a significant example of twentieth-century hospitality architecture and elite social space in San Isidro. Its Californian colonial design, preserved interiors, gardens, terraces, and art collection give the property substantial architectural, historical, and audiovisual value.",
        "long": "Located at Avenida Los Eucaliptos 590 in San Isidro, the Country Club Lima Hotel was inaugurated on 8 February 1927 during the presidency of Augusto B. Leguía. Designed by the American architect T. J. O’Brien in a Californian colonial idiom, the complex combines hospitality functions with architectural display and a collection of colonial artworks. Its guestrooms, restaurants, bars, event spaces, gardens, and terraces continue to operate within a five-star hotel while also providing a carefully preserved visual environment for audiovisual production."
      }
    }
  },
  {
    ...
    "descriptions": {
      "young": "Morro Solar is a large rocky hill beside the Pacific Ocean in Chorrillos. From its slopes, visitors can see the bay, the coast, and much of Lima. It is also connected with history, archaeology, geology, religion, astronomy, and the city’s memory.",
      ...
      "professional": "Morro Solar is a prominent coastal landform and multilayered heritage landscape in Chorrillos. Its significance combines military history, archaeology, geology, religious commemoration, astronomical observation, urban memory, and extensive views over Lima’s southern coastline."
    },
    ...
    "texts": {
      "young": {
        "brief": "Morro Solar is a rocky hill in Chorrillos with important history and wide views of Lima and the Pacific Ocean.",
        "mid": "Morro Solar is a large rocky hill beside the Pacific Ocean in Chorrillos. From its slopes, visitors can see the bay, the coast, and much of Lima. It is also connected with history, archaeology, geology, religion, astronomy, and the city’s memory.",
        "long": "Morro Solar is a rocky formation in Chorrillos that rises about 281 metres above the coast. It overlooks the Bay of Chorrillos, the Costa Verde, the Pacific Ocean, and a large part of Lima. The site is more than a viewpoint: it is also a historic battlefield, an archaeological and geological area, a religious destination, and a place for astronomical observation. Its main landmarks include the Monument to the Unknown Soldier, the planetarium and observatory, the Pope’s Cross, the Sanctuary of the Virgin, and the Cristo del Pacífico."
      },
      "adult": {
      ...
      "professional": {
        "brief": "Morro Solar is a prominent coastal landform and multilayered heritage landscape in Chorrillos.",
        "mid": "Morro Solar is a prominent coastal landform and multilayered heritage landscape in Chorrillos. Its significance combines military history, archaeology, geology, religious commemoration, astronomical observation, urban memory, and extensive views over Lima’s southern coastline.",
        "long": "Rising approximately 281 metres above Chorrillos, Morro Solar is a rocky coastal massif overlooking the Bay of Chorrillos, the Costa Verde, the Pacific Ocean, and a substantial portion of Lima. The site operates simultaneously as a historic battlefield, archaeological zone, geological reserve, religious destination, astronomical observation point, and memorial landscape. Monuments and facilities such as the Monument to the Unknown Soldier, the Morro Solar Planetarium and Observatory, the Pope’s Cross, the Sanctuary of the Virgin, and the Cristo del Pacífico materialise these overlapping scientific, civic, and commemorative functions."
      }
    }
  },
  {
    ...
    "descriptions": {
      "young": "The Santa Cruz Residential Complex is a neighbourhood in San Isidro built during the 1960s for middle-class families. Its apartment blocks, houses, gardens, paths, and shared spaces were planned together as one residential community.",
      ...
      "professional": "The Santa Cruz Residential Complex is a representative example of modern collective housing and planned residential development in Lima. Conceived in San Isidro during the 1960s, it integrates multifamily blocks, duplex units, pedestrian circulation, landscaped areas, and communal spaces within a unified urban scheme."
    },
    ...
    "texts": {
      "young": {
        "brief": "The Santa Cruz Residential Complex is a planned neighbourhood built in San Isidro during the 1960s.",
        "mid": "The Santa Cruz Residential Complex is a neighbourhood in San Isidro built during the 1960s for middle-class families. Its apartment blocks, houses, gardens, paths, and shared spaces were planned together as one residential community.",
        "long": "The Santa Cruz Residential Complex is a planned neighbourhood in San Isidro, near the border with Miraflores and the Huaca Santa Cruz archaeological site. It was developed during the 1960s for middle-class families and originally included 446 duplex apartments in about 20 residential blocks. Houses, gardens, plazas, paths, internal streets, and community areas were designed as parts of the same neighbourhood, making the complex an important example of modern collective housing in Lima."
      },
      "adult": {
      ...
      "professional": {
        "brief": "The Santa Cruz Residential Complex is a representative example of modern collective housing and planned residential development in Lima.",
        "mid": "The Santa Cruz Residential Complex is a representative example of modern collective housing and planned residential development in Lima. Conceived in San Isidro during the 1960s, it integrates multifamily blocks, duplex units, pedestrian circulation, landscaped areas, and communal spaces within a unified urban scheme.",
        "long": "Situated in San Isidro near the Miraflores boundary and the Huaca Santa Cruz archaeological site, the Santa Cruz Residential Complex exemplifies the principles of 1960s collective housing. Its original programme comprised approximately 20 residential blocks and 446 duplex apartments for middle-class households. Multifamily buildings, houses, plazas, gardens, pedestrian paths, internal streets, and communal areas form an integrated urban composition, illustrating the period’s attempt to coordinate domestic architecture, circulation, landscape, and community life."
      }
    }
  },
  {
    ...
    "descriptions": {
      "young": "Jorge Chávez International Airport is Peru’s main airport and the country’s most important connection with national and international destinations. Located in Callao beside Lima, it is a place of travel, migration, tourism, trade, and constant movement. Since June 2025, commercial flights have used a new and much larger passenger terminal.",
      ...
      "professional": "Jorge Chávez International Airport is Peru’s principal aviation infrastructure and primary national and international gateway. Located administratively in Callao, it functions as a regional mobility and logistics hub whose architecture and operations embody migration, tourism, commerce, technological modernisation, and Peru’s global connectivity. Its expanded passenger complex has handled all commercial flights since June 2025."
    },
    ...
    "texts": {
      "young": {
        "brief": "Jorge Chávez International Airport is Peru’s main airport and its most important connection with the rest of the world.",
        "mid": "Jorge Chávez International Airport is Peru’s main airport and the country’s most important connection with national and international destinations. Located in Callao beside Lima, it is a place of travel, migration, tourism, trade, and constant movement. Since June 2025, commercial flights have used a new and much larger passenger terminal.",
        "long": "Jorge Chávez International Airport is Peru’s main airport. It is located in Callao, west of central Lima, and uses the international code LIM. Domestic flights connect the capital with other parts of Peru, while international flights travel to the Americas, the Caribbean, and Europe. The airport covers about 935 hectares and includes two runways, a control tower, boarding bridges, parking, hotels, shops, logistics areas, and access roads. Since June 2025, all commercial flights have used a new five-level terminal designed to serve up to 40 million passengers a year. Lima Airport Partners has operated the airport since 2001."
      },
      "adult": {
      ...
      "professional": {
        "brief": "Jorge Chávez International Airport is Peru’s principal aviation infrastructure and primary national and international gateway.",
        "mid": "Jorge Chávez International Airport is Peru’s principal aviation infrastructure and primary national and international gateway. Located administratively in Callao, it functions as a regional mobility and logistics hub whose architecture and operations embody migration, tourism, commerce, technological modernisation, and Peru’s global connectivity. Its expanded passenger complex has handled all commercial flights since June 2025.",
        "long": "Jorge Chávez International Airport, identified by the code LIM, occupies approximately 935 hectares in the Constitutional Province of Callao. Operated by Lima Airport Partners under a state concession since 2001, it integrates domestic and international aviation with logistics, hospitality, commerce, and regional connectivity. Its infrastructure comprises two runways, an air traffic control tower, aircraft platforms, boarding bridges, parking and access systems, hotels, and commercial facilities. Since June 2025, all commercial operations have used a five-level passenger terminal approximately three times larger than its predecessor and designed for progressive capacity of up to 40 million passengers annually."
      }
    }
  }
];
...
const films = [
  {
    ...
    "profile": {
      "description": "Las Sicodélicas is a Mexican-Peruvian co-production from the late 1960s. The film combines black comedy, thriller elements, crime, pop aesthetics, and a playful tone associated with the visual culture of that decade. Its style reflects the influence of spy films, mod fashion, and the colorful, exaggerated atmosphere of 1960s genre cinema.",
      "about": "The story follows a group of young women connected to a criminal plot involving deception, murder, and social appearances. Behind an elegant and playful surface, the film develops a darker story about manipulation, money, and crime. Its characters move through a world of glamour and danger, where humor and suspense coexist.",
      "themes": "Crime, disguise, black humor, femininity, social performance, pop culture, and the influence of international genre cinema.",
      "value": "This film is useful for showing a less realistic and more stylized cinematic image of Lima and Peru. Instead of portraying the city through social realism, it connects Peru with a playful, international, and visually exaggerated film language.",
      "related_location": "Jirón de la Unión",
      "image": "images/imagenes/las sicodelicas jiron de la union.webp"
    }
  },
  {
    "title": "Tarata",
    ...
    "profile": {
      "description": "Tarata is a Peruvian drama centered on the memory of the 1992 Tarata bombing in Miraflores. The film does not approach the event only as a political tragedy, but also as a domestic and urban fracture. It shows how political violence entered residential spaces and affected the everyday life of families in Lima.",
      "about": "The film follows a family from Miraflores during the years of internal violence in Peru. Through their daily routines, fears, family conflicts, and social environment, the story builds a portrait of a city living under tension. The bombing of Tarata becomes the central event that reveals how violence could reach even the most residential and apparently protected areas of the capital.",
      "themes": "Political violence, family, fear, memory, terrorism, urban trauma, and the impact of national conflict on private life.",
      "value": "This film has a direct relationship with Calle Tarata. The street is not only a filming reference, but also the symbolic and historical center of the film. It is one of the strongest links between a Peruvian film and a specific Lima location.",
      "related_location": "Calle Tarata",
      "image": "images/imagenes/tarata calle tarata.webp"
    }
  },
  {
    "title": "Gregorio",
    ...
    "profile": {
      "description": "Gregorio is one of the most important films of Peruvian social cinema from the 1980s. Produced by Grupo Chaski, it portrays Lima through the experience of Andean migration, urban poverty, and childhood on the streets. The film is especially valuable because it presents the city from the point of view of a migrant child.",
      "about": "Gregorio is a boy who migrates with his family from the Andes to Lima. The city appears as a difficult and unequal place where the promise of a better life quickly becomes a struggle for survival. As the family faces poverty and instability, Gregorio begins to work on the streets and discovers a city marked by social contrast, informality, and exclusion.",
      "themes": "Migration, childhood, poverty, informal work, social inequality, cultural displacement, and urban survival.",
      "value": "The film can be connected to Parque Kennedy, Avenida Larco, and central areas of Miraflores as spaces of work, transit, and social contrast. Its value lies in showing Lima not as a tourist postcard, but as a city experienced from the street.",
      "related_location": "Parque Kennedy, Avenida Larco",
      "image": "images/gregorio av larco2.webp"
    }
  },
  {
    "title": "La Hora Final",
  ...
  },
  {
    ...
    "profile": {
      ...
      "themes": "Criollo culture, neighborhood life, popular comedy, music, family, and traditional Lima.",
      "value": "This film connects strongly with the Rímac district, the Rímac River, and the Historic Center of Lima. It is useful for representing an older, musical, and popular image of the city.",
      "related_location": "Río Rímac",
      "image": "images/imagenes/palomillas del rimac.webp"
    }
  },
  {
    "title": "¡Asu Mare!",
    ...
    "profile": {
      "description": "¡Asu Mare! is a Peruvian biographical comedy based on the life and stand-up show of Carlos Alcántara. It became one of the most commercially successful Peruvian films of its time and helped reconnect national cinema with a mass audience.",
      "about": "The film follows Carlos 'Cachín' Alcántara from his childhood and youth to his path toward becoming an actor and public figure. His relationship with his mother is one of the emotional centers of the story. Through humor, the film presents family life, neighborhood memories, economic difficulties, dreams of success, and the formation of a popular entertainer.",
      "themes": "Family, humor, social mobility, neighborhood memory, popular culture, and personal ambition.",
      "value": "The film is useful for representing everyday Lima: family neighborhoods, working-class and middle-class spaces, streets, homes, and places connected to personal memory.",
      "related_location": "Playa Agua dulce",
      "image": "images/imagenes/asumare agua dulce.webp"
    }
  },
  {
    "title": "Juliana",
    ...
    "profile": {
      "description": "Juliana is a Peruvian social drama produced by Grupo Chaski. Like Gregorio, it focuses on childhood, poverty, and the street, but from the perspective of a girl. It is one of the most important Peruvian films about children living and working in Lima.",
      "about": "Juliana is a girl who runs away from home to escape abuse. On the streets, she discovers that surviving as a girl is especially difficult, so she cuts her hair and pretends to be a boy. She joins a group of children who sing on buses and are controlled by an adult who exploits them. Over time, Juliana becomes a figure of resistance and leadership among the children.",
      "themes": "Street childhood, gender, domestic violence, exploitation, survival, rebellion, and social inequality.",
      "value": "This film connects with streets, public transportation, markets, avenues, and informal urban spaces. It shows Lima as a place of danger and survival, especially for children excluded from family and institutional protection.",
      "related_location": "Playa Agua dulce",
      "image": "images/juliana agua dulce.webp"
    }
  },
  {
    "title": "Alias \"La Gringa\"",
    ...
    "profile": {
      "description": "Alias La Gringa is a Peruvian action drama with strong political and prison-related elements. The film is closely associated with El Frontón, an island prison off the coast of Callao. It uses the prison space as both a physical setting and a symbol of isolation, violence, and national conflict.",
      "about": "The story follows a fugitive known as La Gringa, who returns voluntarily to El Frontón prison to rescue a professor who once saved his life. Inside the prison, the characters face a violent and unstable environment marked by criminal codes, political prisoners, and institutional control. The island becomes an oppressive space where escape, loyalty, and survival define the story.",
      "themes": "Prison, escape, loyalty, political violence, marginality, isolation, and the internal conflict in Peru.",
      "value": "This film has a direct relationship with Isla El Frontón. It is one of the clearest cases where a location is central to the narrative, atmosphere, and historical meaning of the film.",
      "related_location": "Isla El Frontón",
      "image": "images/imagenes/alias la gringa fronton.webp"
    }
  },
  {
    "title": "Metal y Melancolía",
    ...
    "profile": {
      "description": "Metal y Melancolía is a documentary filmed in Lima during the economic crisis of the early 1990s. It portrays the city through taxi rides and conversations with drivers from different social and professional backgrounds. The film turns the taxi into a moving space of confession, memory, and survival.",
      "about": "The documentary follows different people who drive taxis to survive during a period of crisis. Many of them were once professionals, public employees, artists, or workers whose lives changed because of inflation and economic collapse. Through their stories, Lima appears fragmented through traffic, streets, car windows, voices, and memories.",
      "themes": "Economic crisis, informal work, mobility, memory, urban melancholy, survival, and social fragmentation.",
      "value": "The film can be connected to many Lima locations because its central location is the city in movement. It works especially well with avenues, downtown Lima, popular districts, residential areas, and places seen from the road.",
      "related_location": "Malecón de Miraflores",
      "image": "images/imagenes/metal y melancolia malecon.webp"
    }
  },
  {
    "title": "Lima 13",
  ...
  },
  {
    ...
    "profile": {
      "description": "Esta es la U is a sports documentary dedicated to Universitario de Deportes, one of Peru's most important football clubs. It was produced in the context of the club's centenary and works as a tribute to its history, players, supporters, and collective identity.",
      "about": "The documentary follows the history and emotional universe of Universitario de Deportes through archival material, testimonies, football memories, and the passion of its supporters. It connects the club's sporting achievements with its cultural role in Peruvian society.",
      "themes": "Football, memory, fandom, sporting identity, community, tradition, and Peruvian popular culture.",
      "value": "This documentary connects directly with Estadio Lolo Fernández, one of the most symbolic spaces in the history of Universitario. It can also relate to urban areas connected to football memory and fan culture.",
  ...
  },
  {
    ...
    "profile": {
      "description": "Caídos del Cielo is a choral drama by Francisco Lombardi set in Lima during a period of crisis. The film presents different stories that reveal a city marked by inequality, frustration, decay, and social tension.",
      "about": "The film connects several characters whose lives are shaped by loneliness, economic difficulty, and emotional wounds. Through these stories, Lima appears as a fragmented city where chance, poverty, and desire intersect. The urban landscape becomes part of the film's atmosphere of decline and uncertainty.",
      "themes": "Social crisis, inequality, death, loneliness, urban decay, chance, and moral collapse.",
      "value": "The film can be connected to the Miraflores Boardwalk, the Costa Verde, Playa Agua Dulce, and other locations that show Lima as a city of sharp social and visual contrasts.",
      "related_location": "Miraflores Boardwalk",
      "image": "images/imagenes/caidos del cielo miraflores.webp"
    }
  },
  {
    "title": "Viaje a Tombuctú",
    ...
    "profile": {
      ...
      "themes": "Adolescence, love, memory, terrorism, imagination, political violence, and the loss of innocence.",
      "value": "The film connects strongly with Playa Cantolao and La Punta. The coastal landscape works as a space of memory, youth, nostalgia, and emotional transition.",
      "related_location": "Playa Cantolao",
      "image": "images/imagenes/viaje a tombuctu cantolao.webp"
    }
  },
  {
    "title": "No Se Lo Digas a Nadie",
    ...
    "profile": {
      ...
      "value": "The film is connected to the Pontifical Catholic University of Peru (PUCP), as well as to areas of Lima associated with the city's upper and upper-middle classes.",
      "related_location": "Pontifical Catholic University of Peru (PUCP)",
      "image": "images/imagenes/nose lo digas a nadie.webp"
    }
  },
  {
    "title": "Viejos amigos",
    ...
    "profile": {
      ...
      "image": [
        "images/imagenes/viejos amigos monumental callao 3.webp",
        "images/imagenes/viejos amigos barco cantolao.webp"
      ]
    }
  },
  {
    ...
    "profile": {
      "description": "Arde Lima is a documentary about the Peruvian drag scene. It records artistic practices, personal stories, performance spaces, and forms of resistance within a city where diversity often has to fight for visibility.",
      "about": "The film presents the lives and performances of several drag artists in Lima. Through interviews, shows, memories, and urban nightlife, it explores drag as art, identity, community, and survival. The documentary also reflects on discrimination, visibility, and the construction of alternative cultural spaces.",
      "themes": "Drag performance, LGBTQ+ culture, nightlife, identity, resistance, memory, and artistic expression.",
      "value": "The film relates strongly to Calle de las Pizzas, Miraflores nightlife, bars, performance venues, and urban spaces connected to diversity and queer culture.",
      "related_location": "Calle de las Pizzas",
      "image": "images/imagenes/ArdeLima calle delas pizzas.webp"
    }
  },
  {
    "title": "Un mundo para Julius",
    ...
    "profile": {
      "description": "Un mundo para Julius is the film adaptation of Alfredo Bryce Echenique's novel. It portrays Lima's upper class through the eyes of a child who gradually becomes aware of the inequalities that structure his family and social world.",
      "about": "Julius is a child from a wealthy Lima family. He grows up surrounded by luxury, servants, strict social codes, and emotional distance. Through his innocent perspective, the film reveals the contradictions of an aristocratic world: affection and hierarchy, privilege and exclusion, beauty and cruelty.",
      "themes": "Childhood, class inequality, aristocracy, domestic service, privilege, innocence, and social critique.",
      "value": "The film relates strongly to  Bosque El Olivar, Country Club Lima Hotel and residential San Isidro. These spaces visually represent the social world that the film observes and questions.",
      "related_location": "Country Club Lima Hotel",
      "image": "images/imagenes/un mundo para julius country club.webp"
    }
  },
  {
    "title": "El embajador y yo",
    ...
    "profile": {
      "description": "El embajador y yo is a Peruvian film from the 1960s associated with a more elegant and urban image of Lima. Its cast includes figures linked to Peruvian entertainment, television, and popular culture of the period.",
      "about": "Although detailed public information about the plot is limited, the film can be read as part of a cinema interested in social intrigue, modern urban spaces, diplomacy, and refined environments. It belongs to a period in which Peruvian cinema also explored cosmopolitan and socially polished images of the capital.",
      ...
      "images": "images/el embajador y yo aeropuerto.webp"
    }
  },
  {
    "title": "La última tarde",
    ...
    "profile": {
      ...
      "themes": "Memory, former love, divorce, political militancy, guilt, dialogue, and post-conflict reflection.",
      "value": "The film connects well with Bosque El Olivar, Puente de los Suspiros, Barranco, and other walking spaces where the city becomes a place for remembering and confronting the past.",
      "related_location": "Bosque El Olivar and Puente de los Suspiros",
      "image": "images/imagenes/gal-laultimatarde-8.webp"
    }
  },
  {
    "title": "Cholo",
  ...
  },
  {
    ...
    "profile": {
      ...
      "related_location": "Jirón de la Unión",
      "image": "images/imagenes/las chicas de jiron de la union.webp"
    }
  },
  {
    "title": "Avenida Larco, la película",
    ...
    "profile": {
      "description": "Avenida Larco, la película is a Peruvian musical drama inspired by the songs and cultural legacy of the rock band Frágil. The film combines music, friendship, romance, and the difficulties faced by young artists who try to build a place for themselves in Lima's creative scene.",
      "about": "The story follows a group of young musicians who form a rock band and attempt to develop their artistic project while dealing with personal conflicts, economic limitations, relationships, and the pressure to choose between stability and their musical ambitions. Their journey uses songs associated with Peruvian rock to connect individual experiences with the cultural memory of several generations.",
      "themes": "Music, friendship, youth, artistic ambition, romance, identity, perseverance, and Peruvian rock culture.",
      "value": "The film connects directly with Avenida Larco, Miraflores, concert spaces, rehearsal rooms, and nightlife areas. It is useful for presenting Lima as a city of musical memory and for linking a well-known avenue with the history of Peruvian rock.",
      "related_location": "Avenida Larco",
      "image": "images/avenida-larco.webp"
    }
  },
  {
    "title": "Gen Hi8",
    ...
    "profile": {
      "description": "Gen Hi8 is a Peruvian independent film associated with youth culture, audiovisual experimentation, and the use of low-cost video technology. Its title refers to the Hi8 format, a medium closely linked to home video, personal recording, and alternative filmmaking during the transition from analog to digital images.",
      "about": "The film explores the experiences, relationships, and creative impulses of a younger generation through an intimate and unconventional audiovisual language. Rather than presenting Lima as a polished postcard, it approaches the city through personal spaces, streets, informal encounters, and images that resemble private recordings or fragments of memory.",
      ...
      "related_location": "Residencial Santa Cruz",
      "image": "images/imagenes/gen8 santacruz.webp"
    }
  }
];
